...
<% Evaluaciones evaluacionReg = (Evaluaciones) request.getAttribute("evaluacion"); %>
    ...
    <div class="row">
        <div class="col">
            <div class="form-container">
                ...
                <form action="docente?action=formCrear" method="POST">
                    ...
                    <!Estoy asumiento que el profesor va a ingresar correctamente los datos>
                    <div class="form-group">
