...
<% Usuario docenteEdit = (Usuario) request.getAttribute("docente"); %>
    ...
    <div class="row">
        <div class="col">
            <div class="form-container">
                ...
                <form action="decanoDocente?action=editar&iddocente=<%=docenteEdit.getIdUsuario()%>" method="POST">
                    <div class="form-group">
                        <label for="nombre">Nombre Docente</label>
                        <input type="text" class="form-control" id="nombre" name="nombre" placeholder="<%=docenteEdit.getNombre()%>">
                    </div>
                    <button type="submit" class="btn btn-primary btn-block mt-4">Editar</button>
                    <a href="decanoDocente?action=lista" class="btn btn-secondary btn-block mt-3">Cancelar</a>
                </form>
            </div>
        </div>
    </div>
